...
import com.example.emos.workflow.common.util.RedisCache;
import com.example.emos.workflow.config.RabbitMQConfig;
import com.example.emos.workflow.strategy.WorkflowStrategyFactory;
...
public class Receiver {
    ...
    public void retry(Message message, Channel channel) throws IOException, InterruptedException {
        ...
        try {
            ...
            String code = (String) msh.get(Constants.RABBIT_TARGET);

            WorkflowStrategyFactory.toService(code, msg);
