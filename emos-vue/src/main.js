...
app.use(VueNativeSock,"ws://112.124.56.83:8090/emos-api/socket",{ 
    "format": "json"
});

//导入Cookie库，可以读写Cookie数据112.124.56.83
...
//后端项目的URL根路径
let baseUrl = "http://112.124.56.83:8090/emos-api/"
...
//封装用于判断用户是否具有某些权限的公共函数,登陆后会将角色对应权限存储在 localStorage 中，访问某些功能时会进行判断用户是否有对应的权限
