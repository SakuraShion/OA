<template>
	...
	>
		<nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
				...
				<el-menu class="site-navbar__menu site-navbar__menu--right" mode="horizontal">
					...
					<el-menu-item class="site-navbar__avatar" index="3">
						<el-dropdown>
							...
							<template #dropdown>
								<el-dropdown-menu>
									<el-dropdown-item @click="setPhotoHandle()">
										设置头像
									</el-dropdown-item>
			...
			<set-photo v-if="setPhotoVisible" ref="setPhoto"></set-photo>
		</nav>
...
import SetPhoto from './set-photo.vue';
...
export default {
	...
	methods: {
		...
		setPhotoHandle: function() {
			// 为 true 时显示设置头像控件，false 隐藏
			this.setPhotoVisible = true;
			this.$nextTick(() => {
				this.$refs.setPhoto.init();
			})
		},
